...
FROM 
    bookdatabase.book 
WHERE 
    name_category_book = 'Machine Learning';
");
            ...
            <div class="container-sanpham">
                ...
                <div class="inner-left">
                    ...
                    <div class="sanpham-moi">
                        ...
                        <div class="product-new">
                            <a href=""> <img src="../BOOK_FOR_PROJECT/MACHINE_LEARNING_AND AI/DEEP LEARNING FOUNDATIONS AND CONCEPTS/DEEP LEARNING FOUNDATIONS AND CONCEPTS.webp" alt="" width="150px"></a>
                            <div class="description">
                                <p>AiForCybersecurity</p>
